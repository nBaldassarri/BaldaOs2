...
--Home Frame:
homeFrame:addLabel("titleLabel"):setText("BALDA OS"):setFontSize(2):setPosition(16,2)
visualButton(homeFrame:addButton("updateButton"):setText("AGGIORNA"):setSize(13,3):setPosition(2,4):onClick(function()
