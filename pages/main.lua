...
visualButton(programFrame:addButton("edoButton"):setText("edo"):setSize(13,3):setPosition(2,10):onClick(function()
    shell.run("./programs/edo.lua")
end):show())
visualButton(programFrame:addButton("edo2Button"):setText("edo2"):setSize(13,3):setPosition(16,2):onClick(function()
    openProgram("./programs/edo2.lua")
end):show())
visualButton(programFrame:addButton("edo3Button"):setText("edo3"):setSize(13,3):setPosition(16,6):onClick(function()
    openProgram("./programs/edo3.lua")
end):show())
